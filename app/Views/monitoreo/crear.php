...
<div class="container mt-3">
    <div class="row justify-content-between align-items-center">
        <h3 class="col-auto">Nuevo monitoreo</h3>
        <div class="col-auto">
    ...
    <form action="<?php echo base_url('monitoreos/registrar'); ?>" method="post" class="row g-3" id="formularioEmpleado">
        <div class="col-md-6">
            <label for="fecha_monitoreo" class="form-label">Fecha</label>
            <input required type="DATE" size="5" class="form-control" name="fecha_monitoreo" id="fecha_monitoreo">
        </div>
        <div class="col-md-6">
